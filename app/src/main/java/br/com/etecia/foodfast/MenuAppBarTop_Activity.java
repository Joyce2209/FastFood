            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.mFavorite:
                        ...
                        break;
                    case R.id.mSearch:
                        Toast.makeText(getApplicationContext(), "Cliquei no search", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.mMore:
                        Toast.makeText(getApplicationContext(), "Cliquei no more", Toast.LENGTH_SHORT).show();
                        break;
                }
